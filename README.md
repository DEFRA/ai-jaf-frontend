...
```bash
docker build --target development --no-cache --tag ai-jaf-frontend:development .
```

Run:

```bash
docker run -p 3000:3000 ai-jaf-frontend:development
```
...
```bash
docker build --no-cache --tag ai-jaf-frontend .
```

Run:

```bash
docker run -p 3000:3000 ai-jaf-frontend
```
